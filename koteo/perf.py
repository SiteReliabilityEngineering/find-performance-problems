...
class Vmstat(object):
    ...
    def chk_cpu_use(self):
        ...
        if self.calc_cpuavg >= 80 and self.calc_cpuavg < 90:
            return "Look your CPU usage, it's high. CPU %s usage" % (self.alc_cpuavg)
        elif self.calc_cpuavg > 90:
            return "Look your CPU usage, it's VERY high. CPU %s usage" % (self.alc_cpuavg)
        else:
            return "The CPU usage is below 80%. CPU %s usage" % (self.alc_cpuavg)
